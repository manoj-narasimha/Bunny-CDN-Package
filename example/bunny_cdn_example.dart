...
void main() async {
  ...
  final uploadedFile = await bunny.uploadFile(
      "example.png", await file.readAsBytes(),
      path: "path/to/directory/");
  print("File uploaded: $uploadedFile"); // return true if uploaded

  // download a file to a specific directory
  final downloadMyFile =
      await bunny.downloadFile("example.png", "path/to/downloaded_example.png");
